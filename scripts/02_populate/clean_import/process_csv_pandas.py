...
# Define the columns we want to keep based on temp_medicine_2021 table
columns_to_keep = [
    'ATC5', 'CIP13', 'l_cip13', 'TOP_GEN', 'GEN_NUM', 
...
for chunk in pd.read_csv(input_file, sep=';', chunksize=chunk_size, 
                         ...
                         on_bad_lines='warn',
                         usecols=lambda x: x in columns_to_keep):  # Only load necessary columns
