...
DB_HOST="localhost"
DB_PORT="5432"
FILE_PATH="/Users/laurentstaub4/documents/open_medic/csv_data/OPEN_MEDIC_2017.csv"
YEAR=2017

# Process the file with pandas
echo "Processing CSV file..."
python3 process_csv_pandas.py "$FILE_PATH" "clean_2017.csv" "$YEAR"

# Create a temporary staging table
echo "Creating staging table..."
psql -h $DB_HOST -p $DB_PORT -U $DB_USER -d $DB_NAME -c "
DROP TABLE IF EXISTS temp_medicine_2017;
CREATE TABLE temp_medicine_2017 (
    ATC1 TEXT,
    l_ATC1 TEXT,
    ATC2 TEXT,
    L_ATC2 TEXT,
...
psql -h $DB_HOST -p $DB_PORT -U $DB_USER -d $DB_NAME -c "
CREATE TABLE IF NOT EXISTS medicine_sales_2017 PARTITION OF medicine_sales
...
\copy temp_medicine_2017 FROM 'clean_2017.csv' WITH (FORMAT csv, DELIMITER ';', HEADER true, ENCODING 'UTF8');
EOF
...
# Clean up
psql -h $DB_HOST -p $DB_PORT -U $DB_USER -d $DB_NAME -c "DROP TABLE temp_medicine_2017;"
rm clean_2017.csv

echo "Import of 2017 data completed successfully!"
